using MaPremiereAppMVC.Context;
...
namespace MaPremiereAppMVC.Controllers
{
    public class AuthController : Controller
    {
        ...
        public IActionResult Login(AuthLoginForm form)
        {
            ...
            //si NON: return View();
            User? user = FakeDb.Users.SingleOrDefault(u => u.UserName == form.Username, null);

            if (user == null) 
            {
                ModelState.AddModelError(nameof(form.Username), "Identifiant Incorrect");
                return View();
            } 
